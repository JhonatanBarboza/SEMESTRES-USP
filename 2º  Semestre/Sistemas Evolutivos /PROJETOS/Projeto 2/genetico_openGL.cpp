...
#define maxx 20      // Valor máximo do domínio da função x
#define minx 0       // Valor mínimo do domínio da função x
#define maxy 15      // Valor máximo do domínio da função y
#define miny -15      // Valor mínimo do domínio da função y
#define TaxMut 0.0001   // Taxa de mutação (ajustada)
...
int main(int argc, char** argv) {
    ...
    glutCreateWindow("Grafico da Populacao e Funcao de Aptidao");
    initOpenGL();
