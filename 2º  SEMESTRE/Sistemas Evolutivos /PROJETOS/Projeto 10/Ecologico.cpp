...
void gerar_filho_predador(int pai, int mae, int i) {
    ...
    // Mutação
    // A velocidade recebe um incremento aleatório no intervalo [0.0, 0.2]
    predadores[i].velocidade += ((rand() % 100) / 100.0f) * 0.2f;

    // O alcance de visão recebe um incremento aleatório no intervalo [0, 19]
...
void gerar_filho_presa(int pai, int mae, int i) {
    ...
    //mutação
    // A velocidade recebe um incremento aleatório no intervalo [0.0, 0.1]
    presas[i].velocidade += ((rand() % 100) / 100.0f) * 0.1f;
    // O alcance de visão recebe um incremento aleatório no intervalo [0, 2]
