...
float ganhar_energia_presas = 5.0f;
float ganhar_energia_arbustos = 5.0f;

float retirar_energia_predadores = 0.1f;
float retirar_energia_presas = 0.1f;
...
float velocidade_predadores = 0.4f;
float velocidade_presas = 0.0f;
float velo_randomica_predadores = 1.0f;
float velo_randomica_presas = 0.7f;

int visao_predadores = 30;
int visao_presas = 0;
int visao_randomica_predadores = 100; // 1
int visao_randomica_presas = 50; // 1
...
void gerar_filho_presa(int pai, int mae, int i) {
    ...
    presas[i].alcance_visao += rand() % 10;
